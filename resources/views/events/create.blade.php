                    ...
                    <form action="{{ route('events.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" required class="w-full rounded-xl bg-slate-900 border-slate-700 text-white shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 transition-shadow @error('title') border-red-500 @enderror">
                                @error('title')
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="date" id="date" value="{{ old('date') }}" required class="w-full rounded-xl bg-slate-900 border-slate-700 text-white shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 transition-shadow @error('date') border-red-500 @enderror">
                                @error('date')
                                    <p class="text-sm text-red-400 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="location" id="location" value="{{ old('location') }}" placeholder="Ex: Campus Paris, Espace Champerret..." required class="w-full rounded-xl bg-slate-900 border-slate-700 text-white shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 transition-shadow placeholder-slate-500 @error('location') border-red-500 @enderror">
                                @error('location')
                                    <p class="text-sm text-red-400 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3" required class="w-full rounded-xl bg-slate-900 border-slate-700 text-white shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 transition-shadow @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="text-sm text-red-400 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="subjects" id="subjects" rows="2" placeholder="Ex: Intelligence Artificielle, Web, Cybersécurité..." class="w-full rounded-xl bg-slate-900 border-slate-700 text-white shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 transition-shadow placeholder-slate-500">{{ old('subjects') }}</textarea>
                            </div>

                            <!-- Elements à ramener -->
                            <div>
                                <label for="requirements" class="block text-sm font-bold text-slate-300 mb-1">Éléments à ramener par les élèves</label>
                                <textarea name="requirements" id="requirements" rows="3" placeholder="Ex: Goodies, Plaquettes, Ordinateur personnel..." class="w-full rounded-xl bg-slate-900 border-slate-700 text-white shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 transition-shadow placeholder-slate-500">{{ old('requirements') }}</textarea>
                            </div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6 border-t border-slate-700">
                            <a href="{{ route('events.index') }}" class="text-slate-400 hover:text-white font-medium">Annuler</a>
